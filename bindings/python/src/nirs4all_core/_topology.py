...
_RELEASE_POINTERS: dict[str, Any] = {
    "license": {
        ...
        "files": [
            ...
            "bindings/python/LICENSES/AGPL-3.0-or-later.txt",
            "bindings/python/LICENSES/CeCILL-2.1.txt",
            "bindings/python/LICENSING.md",
            "bindings/python/THIRD_PARTY_NOTICES.md",
            "bindings/wasm/LICENSE",
            "bindings/wasm/LICENSES/AGPL-3.0-or-later.txt",
            "bindings/wasm/LICENSES/CeCILL-2.1.txt",
            "bindings/wasm/LICENSING.md",
            "bindings/wasm/THIRD_PARTY_NOTICES.md",
            "bindings/matlab/LICENSE",
            "bindings/matlab/LICENSES/AGPL-3.0-or-later.txt",
            "bindings/matlab/LICENSES/CeCILL-2.1.txt",
