...
class ReleaseTopologyManifestTests(unittest.TestCase):
    ...
    def test_optional_upstreams_are_explicit_and_match_python_extras(self) -> None:
        ...
        self.assertIn("nirs4all-methods>=1.0.8", extras["methods"])
        self.assertIn("pls4all>=1.0.8", extras["methods"])
        self.assertIn("scikit-learn>=1.3", extras["methods"])
        self.assertIn("nirs4all-formats>=0.2.6", all_extra)
        self.assertIn("nirs4all-io>=0.1.10", all_extra)
        self.assertIn("nirs4all-methods>=1.0.8", all_extra)
        self.assertIn("pls4all>=1.0.8", all_extra)
